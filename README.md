...
Content width is way more sparse and higher scaled than original target page and Title of the browser tab also not accurate at all the actual title of the page says document instead of `Cursor` . Also no favicon was used.
...
The ***Company logo*** section text is a lot bigger than the original web site. Also the logos section is again a lot bigger than the target.
...
***CTA Section*** has extra border. The download button text arrow icon is missing.
...
No `header` , `main` , `section` , `article` tags used in the whole HTML document , although syntactically correct semantically the web page is terrible and accessibility compromised a lot.

Also generic tags like `p` and `div` tags are used where `time` and `section` , `article` would have been a perfect fit.

**Improvement tips ::** Before cloning the site you should inspect the source in the Dev tools panel first to see how it is originally structured and designed that will give you a clear map of what you should do.

### Submission Quality Review

No live link or even screenshot provided for the actual submission, the reviewer has no way other than just cloning the code files and assets locally and reviewing them , which is not ideal and takes away a lot of time from reviewer and affect review quality.


***Improvement tips::*** It is in your best interest to make sure that from your

README fully missing in the actual repository too as of commit hash `e791a04e1a624638f0efa60371e575adba0057e3` at the point of this review being made.
All of the remarks, evaluation and checking was done based on this commit hash only as it being the latest commit at this point of time.

### Final remarks

Your efforts are there but a lot of work and hard-work and polish is still needed too reach production quality. Your total  100 marks was divided in 3 parts in this evaluation.
